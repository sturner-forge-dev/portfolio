...
- Joined the Core Services Team post-merger, focusing on integrating RateGenius services with the Autopay Loan Origination System. Worked in a team of three to design high level architecture of future engineering projects.
- Transitioned critical NXG system components to a microservice for lender management, significantly improving application conversion rates and operational efficiency.
- Developed a vehicle contract generation service, saving the company $12,000/yr.
- Acted as a technical representative for onboarding new lending partner, compiling technical documentation and implementation plans, resulting in one of the top three revenue-generating lenders.
